...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 125 26" }, props),
        React.createElement("image", { width: "125", height: "26", href: isDark ? '/images/logo-icon-swapp.png' : '/images/logo-icon-black.png' })))
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$1, null, links.map(function (entry) {
        ...
        if (entry.items) {
            var itemsMatchIndex = entry.items.findIndex(function (item) { return item.href === window.location.href; });
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { navbackground:"#fff3e0",textwhite:"#000",color_balck:"000",color_blue:"#000",primaryblack:"#000",textblack:"#ccc",orange_color:"#f3841e",orangetext_subhead:"#333",dash_heading:"#333",background: "#fff3e0", textblack:"#333", backgroundDisabled: "#e0b87d", contrast: "#333", invertedContrast: "#FFFFFF", input: "#e0b87d", inputSecondary: "#e0b87d", tertiary: "#fbe9cc", text: "#000", textDisabled: "#a7623c", textSubtle: "#6e2d0a", borderColor: "#e0b87d", card: "#fff",  card_small: "#333", gradients: {
    bubblegum: "linear-gradient(139.73deg, #fff 0%, #fff 100%)",
} });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { navbackground:"#1a110d",textwhite:"#fff",color_balck:"fff",color_blue:"#fff",primaryblack:"#fff",textblack:"#fff",orange_color:"#f3841e", orangetext_subhead:"#fff",dash_heading:"#fff",secondary: "#fff", textblack:"#fff", background: "#1a110d", backgroundDisabled: "#152b36", contrast: "#FFFFFF", invertedContrast: "#170903", input: "#6e2d0a7d", inputSecondary: "#1a110d", primaryDark: "#0098A1", tertiary: "#1a110d", text: "#fff", textDisabled: "#fff",  card_small: "#fff",textSubtle: "#fff", borderColor: "#33190b", card: "#170903", new: "#ffffff", gradients: {
    bubblegum: "linear-gradient(139.73deg, rgb(12 12 12/50%) 0%, rgb(12 12 12/50%) 100%)",
} });
// var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#fff3cd", backgroundDisabled: "#e0b87d", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#fff3cd", inputSecondary: "#d7caec", tertiary: "#fff3cd", text: "#ff841a", textDisabled: "#002f44", textSubtle: "#ff841a", borderColor: "#e0b87d", card: "#FFFFFF",  card_small: "#bd8a3e", gradients: {
//     bubblegum: "linear-gradient(139.73deg, #fff3cd 0%, #fff3cd 100%)",
// } });
// var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#19191c", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#323232", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#fff", textSubtle: "#ff841a", borderColor: "#33190b", card: "#27262c", gradients: {
//     bubblegum: "linear-gradient(139.73deg, rgb(12 12 12/50%) 0%, rgb(12 12 12/50%) 100%)",
// } });
